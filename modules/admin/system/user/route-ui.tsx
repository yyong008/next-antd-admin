...
import CreateUserModal from '@/modules/admin/system/user/user/create-user-model';
import { formatDate } from '@/app/utils';
import { useState } from 'react';
import { useUserNav } from '@/hooks/router';

export function RouteUI({ dataSource, depts, roles, total }: any) {
